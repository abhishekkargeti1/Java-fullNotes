...
// int Phy = sc.nextInt();
// int chm = sc.nextInt();
// int Total = maths+Phy+chm;
//     if(Total >=190 ||Total >=140 && maths>=65&& Phy>=55 && chm >=50 ){
...
// System.out.println("Enter youe Computer marks");
...
//Answer
    ...
    //    if(Heigth == breadth&& Heigth == length){
    //     System.out.println("Equilateral");
    //    }else if( Heigth == breadth &&  Heigth!= length){
...
//     }
    ...
    // char userInput = Character.toLowerCase(Input);
    ...
    //Answer
        ...
        // System.out.println("Enter Sell Cost");
        // int sellcost = sc.nextInt();
        // int differencecost= sellcost-purchasecost;
        // if(differencecost<0){
...
// float billamounts;
// if(units<=199){
//     billamounts = units*1.20f;
//     System.out.println(billamounts);
// }else if(units>200||units<=400){
//     billamounts= units*1.50f;
//     if(billamounts>400){
//         billamounts += 100;
//     System.out.println(billamounts);
//     }
// }else if(units>400||units<=600){
//     billamounts= units*1.80f;
//     System.out.println(billamounts);
    
// }else{
//     billamounts= units*2.00f;
//     System.out.println(billamounts);
